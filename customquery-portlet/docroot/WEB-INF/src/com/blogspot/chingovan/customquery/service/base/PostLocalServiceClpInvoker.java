...
public class PostLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return PostLocalServiceUtil.addPost((com.blogspot.chingovan.customquery.model.Post)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return PostLocalServiceUtil.deletePost((com.blogspot.chingovan.customquery.model.Post)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return PostLocalServiceUtil.updatePost((com.blogspot.chingovan.customquery.model.Post)arguments[0]);
		}
		...
		if (_methodName48.equals(name) &&
			...
			return PostLocalServiceUtil.findByAuthors((long[])arguments[0],
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue());
		}
