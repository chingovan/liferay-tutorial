...
import com.blogspot.chingovan.customquery.model.AuthorClp;
import com.blogspot.chingovan.customquery.model.PostClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"customquery-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "customquery-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.blogspot.chingovan.customquery.model.impl.AuthorImpl")) {
			return translateOutputAuthor(oldModel);
		}

		if (oldModelClassName.equals(
					"com.blogspot.chingovan.customquery.model.impl.PostImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.blogspot.chingovan.customquery.NoSuchAuthorException")) {
			return new com.blogspot.chingovan.customquery.NoSuchAuthorException();
		}

		if (className.equals(
					"com.blogspot.chingovan.customquery.NoSuchPostException")) {
			return new com.blogspot.chingovan.customquery.NoSuchPostException();
		}
