...
public class AuthorWrapper implements Author, ModelWrapper<Author> {
	...
	*/
	...
	@Override
	public int compareTo(com.blogspot.chingovan.customquery.model.Author author) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.blogspot.chingovan.customquery.model.Author> toCacheModel() {
		return _author.toCacheModel();
	}

	@Override
	public com.blogspot.chingovan.customquery.model.Author toEscapedModel() {
		return new AuthorWrapper(_author.toEscapedModel());
	}

	@Override
	public com.blogspot.chingovan.customquery.model.Author toUnescapedModel() {
