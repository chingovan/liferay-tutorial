...
import com.blogspot.chingovan.tutorial.combine.model.StudentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"combine-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "combine-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.blogspot.chingovan.tutorial.combine.model.impl.StudentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.blogspot.chingovan.tutorial.combine.NoSuchStudentException")) {
			return new com.blogspot.chingovan.tutorial.combine.NoSuchStudentException();
		}
