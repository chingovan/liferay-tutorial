...
public class StudentWrapper implements Student, ModelWrapper<Student> {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.blogspot.chingovan.tutorial.ajax.model.Student> toCacheModel() {
		return _student.toCacheModel();
	}

	@Override
	public com.blogspot.chingovan.tutorial.ajax.model.Student toEscapedModel() {
		return new StudentWrapper(_student.toEscapedModel());
	}

	@Override
	public com.blogspot.chingovan.tutorial.ajax.model.Student toUnescapedModel() {
