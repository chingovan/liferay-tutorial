...
import com.blogspot.chingovan.tutorial.ajax.model.StudentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"ajax-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "ajax-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.blogspot.chingovan.tutorial.ajax.model.impl.StudentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.blogspot.chingovan.tutorial.ajax.NoSuchStudentException")) {
			return new com.blogspot.chingovan.tutorial.ajax.NoSuchStudentException();
		}
