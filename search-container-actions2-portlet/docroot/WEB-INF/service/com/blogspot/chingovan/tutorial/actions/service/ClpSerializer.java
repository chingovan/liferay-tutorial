...
import com.blogspot.chingovan.tutorial.actions.model.StudentClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"search-container-actions2-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "search-container-actions2-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.blogspot.chingovan.tutorial.actions.model.impl.StudentImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.blogspot.chingovan.tutorial.actions.NoSuchStudentException")) {
			return new com.blogspot.chingovan.tutorial.actions.NoSuchStudentException();
		}
